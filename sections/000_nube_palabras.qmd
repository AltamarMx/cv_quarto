...
.word-cloud-term:hover::after,
.word-cloud-term:focus::after {
  opacity: 1;
...
body.quarto-dark .word-cloud-term::after {
    ...
    if section_files:
        ...
        if filtered_tokens:
            ...
            for word, count in freq:
                ...
                tooltip = f"{count} {'vez' if count == 1 else 'veces'} escrita"
                spans.append(
                    f"<span class=\"word-cloud-term\" style=\"font-size: {size:.2f}rem; --wc-alpha: {alpha:.2f};\" "
                    f"title=\"{html.escape(tooltip)}\" aria-label=\"{html.escape(tooltip)}\" "
                    f"data-count=\"{count}\" data-tooltip=\"{html.escape(tooltip)}\">"
